...
saveDirectory   = fullfile(thisDirectory,'Cullen2018_R0_Main_threshold');
...
for k = 1:2
    ...
    clear par;
    par = Cullen2018CortexAxon_threshold();
    ...
    for psw = [0 20]
        ...
        par                         = UpdateInternodePeriaxonalSpaceWidth(par, min(3,par.myel.geo.peri.value.ref), [], [1, 2, 51, 52], 'min');
...
set(gcf,...
    ...
    'Renderer','Painters');
print(gcf,[saveDirectory '/Cullen2018_R0_MainResults_threshold.jpg'],'-djpeg','-r300');
print(gcf,[saveDirectory '/Cullen2018_R0_MainResults_threshold.pdf'],'-dpdf');
